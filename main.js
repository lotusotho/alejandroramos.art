...
loader.load('mesa.glb', function ( tablegltf ) {
...
loader.load('litleo.glb', function ( litleogltf ) {
...
loader.load('locomocion2D.glb', function ( locomociongltf ) {
...
loader.load('trampolin.glb', function ( clay1gltf ) {
...
// // BallDeform
 runtime.load( 'BallDeform.json', function( shaderData ) {
...
// RippleKnot
 runtime.load( 'StarsNormals.json', function( shaderData ) {
