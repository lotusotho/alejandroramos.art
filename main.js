...
loader.load('/assets/mesa.glb', function ( tablegltf ) {
...
loader.load('/assets/litleo.glb', function ( litleogltf ) {
...
loader.load('/assets/locomocion2D.glb', function ( locomociongltf ) {
...
loader.load('/assets/trampolin.glb', function ( clay1gltf ) {
...
// // BallDeform
 runtime.load( '/assets/BallDeform.json', function( shaderData ) {
...
// RippleKnot
 runtime.load( '/assets/StarsNormals.json', function( shaderData ) {
